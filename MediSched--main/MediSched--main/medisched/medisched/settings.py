...
SECRET_KEY = 'django-insecure-o1tvp%2=jdry7jb-p^67mti)=l(a6s&f4&4@0hdn%qksok*6o9'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "home/static",   # যদি project level static থাকে
]
...
VIDEO_CALL_SETTINGS = {
    ...
    'CHANNEL_PREFIX': 'medisched_',
    'DOCTOR_EARLY_ACCESS_MINUTES': 15,
    'PATIENT_EARLY_ACCESS_MINUTES': 5,
