...
urlpatterns = [
    ...
    # SIMPLE Video Call (USE THIS)
    path('simple-video-call/<int:appointment_id>/', views.simple_video_call, name='simple_video_call'),
    
    # Old video calls (you can keep or remove these)
    ...
    path('video-call/immediate/<int:appointment_id>/', views.start_immediate_video_call, name='immediate_video_call'),
