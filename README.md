...
# MediSched - Healthcare Appointment and Reminder Management System
...
The project was structured into distinct application modules, which can be mapped to individual responsibilities:

| Member | Primary Modules/Responsibilities |
| :--- | :--- |
| Member 1 | **Users & Authentication** (`users` app, Role-Based Access Control) |
| Member 2 | **Doctor Profile & Management** (`doctor` app, Profile CRUD, Fee Management) |
| Member 3 | **Appointment & Payment** (`appointment` app, Booking Logic, Transaction Models) |
| Member 4 | **Communication & Core** (`communication` app, Agora Integration, System Configuration) |
